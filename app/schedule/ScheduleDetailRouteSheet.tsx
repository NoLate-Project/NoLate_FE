              ...
              >
                    ...
                    <View style={styles.improvedExpandedHeroMain}>
                      ...
                      {hasDepartureInfo && (
                        <Pressable
                          ...
                          disabled={
                            departureCompleted || departureActionPending
                          }
                          accessibilityRole="button"
                          accessibilityLabel={
                          ...
                          style={({ pressed }) => [
                            styles.improvedExpandedDepartureAction,
                            {
                              backgroundColor: departureCompleted
                                ...
                                : APP_ACCENT_BLUE,
                              opacity:
                                pressed || departureActionPending ? 0.64 : 1,
                            },
                          ]}
                        >
                          {departureActionPending ? (
                            ...
                            <Ionicons
                              name={
                                departureCompleted ? 'checkmark' : 'navigate'
                              }
                              size={15}
                              color={
                                departureCompleted
                ...
                <>
                  ...
                  {hasDetailedRoute && routeDetailInfo ? (
                    <>
                      ...
                      >
                        ...
                        {inspectedTravelPlan ? (
                          ...
                          >
                            {hhmmText(fromISO(routeDetailInfo.departureTime))}{' '}
                            출발 기준
                          </Text>
                        ) : null}
                      </View>
                    ...
                    <Text
                      style={[styles.sheetEmptyText, { color: secondaryText }]}
                    >
                      저장된 상세 경로가 없어요.
                    </Text>
                  )}
