    ...
    sections: [
        {
            ...
            body: [
                ...
                "무료 요금제에서 광고 기능이 활성화된 경우 Google Mobile Ads를 통한 제3자 광고 제공, 광고 노출·상호작용 및 성과 측정, 광고 SDK의 안정성·성능 분석",
            ],
        },
        {
            ...
            body: [
                ...
                "광고 및 동의 관리 정보(광고 기능이 활성화된 경우): 광고 식별자(IDFA 등) 또는 앱·개발자 범위의 기기 식별자, IP 주소로부터 추정되는 대략적 위치, 광고 노출·클릭 등 광고 데이터, 앱 실행·탭 등 제품 상호작용, 앱 시작 시간·응답 지연·에너지 사용 등 성능 정보, 충돌 로그와 기타 진단 정보 및 UMP 동의 상태. 실제 처리 항목은 기기·OS 설정, 지역, 이용자의 광고 동의와 iOS 앱 추적 투명성(ATT) 권한 상태에 따라 달라질 수 있습니다.",
            ],
        },
        {
        ...
        },
        {
            ...
            body: [
                ...
                "NoLate는 Google Calendar API로 받은 Google Workspace 사용자 데이터, 그 파생 데이터 또는 Google 접근 토큰을 Google Mobile Ads·AdMob·UMP에 전달하거나 광고 제공·타기팅·측정에 사용하지 않습니다.",
            ],
        },
        {
            title: "4. 보유 및 이용 기간",
            body: [
                ...
                "NoLate 서버는 Google Mobile Ads 또는 UMP가 처리하는 원시 광고 식별자, IP 주소, 광고 노출·상호작용, 충돌·성능·진단 정보 및 광고 동의 상태를 저장하지 않습니다. NoLate의 광고 노출 빈도 정보는 기기에만 저장합니다. Google이 처리하는 정보의 보유·삭제에는 이용자의 선택, Google의 정책 및 관련 법령이 적용됩니다.",
            ],
        },
        {
            title: "5. 개인정보 처리의 위탁",
        ...
        {
            title: "6-1. 광고 제공, 동의 관리 및 추적",
            body: [
                "NoLate는 무료 요금제이고 운영자가 광고 기능을 활성화했으며 Google User Messaging Platform(UMP)이 광고 요청 가능 상태로 확인한 경우에만 Google Mobile Ads SDK를 초기화하여 제3자 전면 광고를 요청합니다. 광고 기능이 비활성화되었거나 운영 광고 단위가 없으면 광고를 요청하지 않습니다.",
                "Google LLC(Google Mobile Ads/AdMob)는 광고 제공, 광고 노출·상호작용 및 성과 분석, 광고 SDK의 안정성 개선을 위해 위 광고 및 동의 관리 정보를 처리할 수 있습니다. UMP는 AdMob 콘솔에서 구성된 개인정보 메시지가 적용되는 경우 광고 관련 개인정보 선택 화면을 표시하고 동의 상태와 광고 요청 가능 여부를 확인합니다.",
                "일부 광고 데이터, 제품 상호작용, 성능 정보와 대략적 위치는 기기 또는 광고 식별자와 연결될 수 있습니다. Google Mobile Ads가 기기 식별자를 다른 회사의 앱·웹사이트에서 얻은 정보와 결합하여 맞춤형 광고 또는 광고 측정에 이용하는 경우 Apple 기준의 추적에 해당할 수 있으며, iOS에서는 ATT 권한 상태에 따라 광고 식별자의 이용 가능 여부가 제한됩니다.",
                "NoLate는 광고 요청에 회원 이름·이메일·NoLate 회원 식별값, 일정·캘린더 내용, 저장 장소 또는 경로 기능에서 사용하는 GPS 기반 정밀 위치를 직접 첨부하지 않습니다.",
                "Google의 정보 처리에는 Google 개인정보처리방침(https://policies.google.com/privacy)과 파트너 사이트·앱 정보 이용 안내(https://policies.google.com/technologies/partner-sites)가 적용됩니다.",
            ],
        },
        {
            title: "7. 파기 절차 및 방법",
        ...
        },
        {
            ...
            body: [
                ...
                "iOS 이용자는 기기 설정의 개인정보 보호 및 보안 > 추적에서 NoLate의 추적 권한을 변경할 수 있습니다.",
            ],
        },
        {
            title: "9. 안전성 확보 조치",
