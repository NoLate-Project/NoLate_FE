...
import { completeMemberCuration } from '../../api/member';
import { getScheduleCategoriesFromApi } from '../../api/scheduleCategories';
import {
  getScheduleCalendars,
  type ScheduleCalendar,
} from '../../api/scheduleCalendars';
import { saveAuthCurationCompleted } from '../../modules/auth/authStorage';
import {
  searchAddressByKeyword,
  type PlaceSearchItem,
} from '../../modules/map/routingService';
import { getWritableCalendarImportCategories } from '../../modules/onboarding/calendarImportCategory';
import { getCalendarImportCompletionRoute } from '../../modules/onboarding/calendarImportNavigation';
import { withCalendarImportTimeout } from '../../modules/onboarding/calendarImportReliability';
import {
  hasFavoriteDepartureCoords,
  saveFavoriteDeparturePlace,
} from '../../modules/schedule/favoriteDeparture';
import { useScheduleStore } from '../../modules/schedule/store';
import type { Place, ScheduleCategory } from '../../modules/schedule/types';
import {
  getErrorMessage,
  isSamePlace,
